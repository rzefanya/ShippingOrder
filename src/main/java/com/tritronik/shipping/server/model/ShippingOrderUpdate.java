...
/**
 * A Shipping Order is a document used by a business to specify what items are to be transferred from a storage location or warehouse to which person and to which new location. A Shipping Order can typically be sent along with a shipment of goods so that the person receiving them can verify that the document correctly reflects the items that they actually received. Skipped properties: id,href
 */
@ApiModel(description = "A Shipping Order is a document used by a business to specify what items are to be transferred from a storage location or warehouse to which person and to which new location. A Shipping Order can typically be sent along with a shipment of goods so that the person receiving them can verify that the document correctly reflects the items that they actually received. Skipped properties: id,href")
@Validated
...
public class ShippingOrderUpdate   {
  ...
  public ShippingOrderUpdate creationDate(Date creationDate) {
  ...
  **/
  ...
  public ShippingOrderUpdate lastUpdateDate(Date lastUpdateDate) {
  ...
  **/
  ...
  public ShippingOrderUpdate status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ShippingOrderUpdate note(List<Note> note) {
    this.note = note;
    return this;
  }

  public ShippingOrderUpdate addNoteItem(Note noteItem) {
    if (this.note == null) {
  ...
  **/
  ...
  public ShippingOrderUpdate placeFrom(RelatedPlaceRefOrValue placeFrom) {
  ...
  **/
  ...
  public ShippingOrderUpdate placeTo(RelatedPlaceRefOrValue placeTo) {
  ...
  **/
  ...
  public ShippingOrderUpdate productOrder(ProductOrderRef productOrder) {
  ...
  **/
  ...
  public ShippingOrderUpdate relatedParty(List<RelatedPartyWithContactInfo> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ShippingOrderUpdate addRelatedPartyItem(RelatedPartyWithContactInfo relatedPartyItem) {
  ...
  **/
  ...
  public ShippingOrderUpdate relatedShippingOrder(RelatedShippingOrder relatedShippingOrder) {
  ...
  **/
  ...
  public ShippingOrderUpdate shippingInstruction(ShippingInstruction shippingInstruction) {
  ...
  **/
  ...
  public ShippingOrderUpdate shippingOrderCharacteristic(List<Characteristic> shippingOrderCharacteristic) {
    this.shippingOrderCharacteristic = shippingOrderCharacteristic;
    return this;
  }

  public ShippingOrderUpdate addShippingOrderCharacteristicItem(Characteristic shippingOrderCharacteristicItem) {
  ...
  **/
  ...
  public ShippingOrderUpdate shippingOrderItem(List<ShippingOrderItem> shippingOrderItem) {
    this.shippingOrderItem = shippingOrderItem;
    return this;
  }

  public ShippingOrderUpdate addShippingOrderItemItem(ShippingOrderItem shippingOrderItemItem) {
  ...
  **/
  ...
  public ShippingOrderUpdate shippingOrderOffering(ProductOfferingRef shippingOrderOffering) {
  ...
  **/
  ...
  public ShippingOrderUpdate shippingOrderPrice(ProductPrice shippingOrderPrice) {
  ...
  **/
  ...
  public ShippingOrderUpdate baseType(String baseType) {
  ...
  **/
  ...
  public ShippingOrderUpdate schemaLocation(String schemaLocation) {
  ...
  **/
  ...
  public ShippingOrderUpdate type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.creationDate, shippingOrderUpdate.creationDate) &&
        Objects.equals(this.lastUpdateDate, shippingOrderUpdate.lastUpdateDate) &&
        Objects.equals(this.status, shippingOrderUpdate.status) &&
        Objects.equals(this.note, shippingOrderUpdate.note) &&
        Objects.equals(this.placeFrom, shippingOrderUpdate.placeFrom) &&
        Objects.equals(this.placeTo, shippingOrderUpdate.placeTo) &&
        Objects.equals(this.productOrder, shippingOrderUpdate.productOrder) &&
        Objects.equals(this.relatedParty, shippingOrderUpdate.relatedParty) &&
        Objects.equals(this.relatedShippingOrder, shippingOrderUpdate.relatedShippingOrder) &&
        Objects.equals(this.shippingInstruction, shippingOrderUpdate.shippingInstruction) &&
        Objects.equals(this.shippingOrderCharacteristic, shippingOrderUpdate.shippingOrderCharacteristic) &&
        Objects.equals(this.shippingOrderItem, shippingOrderUpdate.shippingOrderItem) &&
        Objects.equals(this.shippingOrderOffering, shippingOrderUpdate.shippingOrderOffering) &&
        Objects.equals(this.shippingOrderPrice, shippingOrderUpdate.shippingOrderPrice) &&
        Objects.equals(this.baseType, shippingOrderUpdate.baseType) &&
        Objects.equals(this.schemaLocation, shippingOrderUpdate.schemaLocation) &&
        Objects.equals(this.type, shippingOrderUpdate.type);
  }
